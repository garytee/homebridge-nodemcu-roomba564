...
String roombacontrol     =  "<a href='/clean'<button type='button' class='btn btn-default'><span class='glyphicon glyphicon-play' aria-hidden='true'></span> Start</button></a><a href='/dock'<button type='button' class='btn btn-default'><span class='glyphicon glyphicon-home' aria-hidden='true'></span> Dock</button></a></div>";
...
void setup(void)
{
  ...
  server.on("/clean", handle_roomba_start);
  server.on("/dock", handle_roomba_dock);
